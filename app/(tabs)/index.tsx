              ...
              <View>
                  ...
                  <View>
                    ...
                    <View style={styles.infoBox}>
                      <Text style={styles.infoText}>
                        💡 Transfer will be processed within 2-24 hours. You'll receive a confirmation once completed.
                      </Text>
                    </View>
                  </View>
                )}
                ...
                {selectedPaymentMethod === 'mobile' && (
                  <View>
                    ...
                    <View style={styles.infoBox}>
                      <Text style={styles.infoText}>
                        📱 You'll receive an SMS prompt to authorize the payment from your mobile money account.
                      </Text>
                    </View>
                  </View>
                )}
                ...
                {selectedPaymentMethod === 'cash' && (
                  <View>
                    <View style={styles.inputContainer}>
                      <Text style={styles.inputLabel}>Select Deposit Location</Text>
                      <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.optionsScroll}>
                    ...
                    <View style={styles.infoBox}>
                      <Text style={styles.infoText}>
                        🏪 Visit the selected location with cash and your reference number. Funds will be available immediately after deposit.
                      </Text>
                    </View>
                  </View>
                )}
